...
public class UserResponse {
    ...
    private List<BillingDetailsResponse> billingDetails;
    ...
    public List<BillingDetailsResponse> getBillingDetails() {
        return billingDetails;
    }

    public void setBillingDetails(final List<BillingDetailsResponse> billingDetails) {
